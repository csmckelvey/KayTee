...
<HTML lang="en-US">
	<?php 
		...
		printHeadTag("About Us Page of Kay-Tee Baby Boutique", "Kay-Tee Baby Boutique About Us Page", "", "");
	?>
								...
								<DIV class="container-fluid">
									<DIV>
										<UL class="nav navbar-nav navbar-right">
											...
											<LI class="active"><A class="navlink  active" href="about.html">About</A></LI> 
										</UL>
									</DIV>
								</DIV>
							</NAV>
